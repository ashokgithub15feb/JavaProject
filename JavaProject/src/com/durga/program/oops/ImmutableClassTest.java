...
public class ImmutableClassTest {
	...
	public static void main(String[] args) {
	       ...
	       HashMap<Integer, String> localMap1 = new HashMap<Integer,String>();
	       localMap1.put(120, "120");
	        HashMap<Integer, String> localMap = new HashMap<Integer,String>(localMap1); //local
